...
CHECKS = (
    ...
    (
        ...
        [
            sys.executable,
            "scripts/check_phase6_memory_item_write_future_created_at_fail_closed.py",
        ],
    ),
    (
    ...
    (
        "memory-item write required identity fail closed",
        [
            sys.executable,
            "scripts/check_phase6_memory_item_write_required_identity_fail_closed.py",
        ],
    ),
    (
    ...
    (
        "memory-item write optional identity type fail closed",
        [
            sys.executable,
            "scripts/check_phase6_memory_item_write_optional_identity_type_fail_closed.py",
        ],
    ),
    (
        "memory-item write content type fail closed",
        [
            sys.executable,
            "scripts/check_phase6_memory_item_write_content_type_fail_closed.py",
        ],
    ),
    (
    ...
    (
        "memory-item write metadata key type fail closed",
        [
            sys.executable,
            "scripts/check_phase6_memory_item_write_metadata_key_type_fail_closed.py",
        ],
    ),
    (
    ...
    (
        "memory-item read metadata value fail closed",
        [
            sys.executable,
            "scripts/check_phase6_memory_item_read_metadata_value_fail_closed.py",
        ],
    ),
    (
    ...
    (
        "memory-item read request required identity fail closed",
        [
            sys.executable,
            "scripts/check_phase6_memory_item_read_request_required_identity_fail_closed.py",
        ],
    ),
    (
    ...
    (
        "memory-item write agent conflict fail closed",
        [
            sys.executable,
            "scripts/check_phase6_memory_item_write_agent_conflict_fail_closed.py",
        ],
    ),
    (
        "memory-item write session conflict fail closed",
        [
            sys.executable,
            "scripts/check_phase6_memory_item_write_session_conflict_fail_closed.py",
        ],
    ),
    (
    ...
    (
        "memory-item write created time conflict fail closed",
        [
            sys.executable,
            "scripts/check_phase6_memory_item_write_created_at_conflict_fail_closed.py",
        ],
    ),
    (
    ...
    (
        ...
        [
            sys.executable,
            "scripts/check_phase6_memory_item_read_created_at_fail_closed.py",
        ],
    ),
    (
        "memory-item read created time type fail closed",
        [
            sys.executable,
            "scripts/check_phase6_memory_item_read_created_at_type_fail_closed.py",
        ],
    ),
    (
        "memory-item read future created time fail closed",
        [
            sys.executable,
            "scripts/check_phase6_memory_item_read_future_created_at_fail_closed.py",
        ],
    ),
    (
    ...
    (
        "memory-item read scope fail closed",
        [
            sys.executable,
            "scripts/check_phase6_memory_item_read_scope_fail_closed.py",
        ],
    ),
    (
