...
export function DashboardConnectorsSection({
	...
	const httpPathCount = connectors
														...
														>
																...
																<div className="flex flex-wrap items-center gap-2">
																	...
																	>
																		{config.token_configured
																			...
																			: t(
																					'platform.connectors.tokenNotConfigured',
																				)}
																	</Badge>
																</div>
															...
															<div className="flex items-center justify-end">
																<Button
																	...
																	variant="outline"
																	onClick={() =>
																		loadSavedConnectorConfig(config)
																	}
																>
										...
										<div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
											...
											<div className="flex flex-wrap gap-2">
												...
												>
													<Save
														className={cn(
															savingConnectorConfig && 'animate-pulse',
														)}
													/>
													{savingConnectorConfig
												...
												<Button
													...
													disabled={
														testingConnector || connectorDraftIssues.length > 0
													}
												>
													<Play
														className={cn(testingConnector && 'animate-pulse')}
													/>
													{testingConnector
												...
												<Button
													...
													size="sm"
													onClick={() =>
														void handleTestAndSaveConnectorConfig()
													}
													disabled={
														testingConnector ||
														savingConnectorConfig ||
												...
												<StateBadge
													...
													label={
														connectors.runtime.saved_config_enabled
															? t(
																	'platform.connectors.runtimeSavedConfigEnabled',
																)
															: t(
																	'platform.connectors.runtimeSavedConfigDisabled',
																)
													}
												/>
											</div>
						...
						<TabsContent value="catalog" className="mt-0">
							<div className="grid gap-4 xl:grid-cols-2">
										...
										{connectors.supported.map((connector) => (
											...
											>
												<div className="flex flex-wrap items-center justify-between gap-2">
													...
													<Badge variant="secondary">{connector.mode}</Badge>
												</div>
								...
								<div className="grid gap-3 rounded-lg border bg-background p-4 shadow-sm">
									...
									<div className="grid gap-2">
										{Object.entries(connectors.http_paths).map(
											([name, path]) => (
												<div
													key={name}
