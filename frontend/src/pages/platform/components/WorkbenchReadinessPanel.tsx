...
export function WorkbenchReadinessPanel({
	...
	return (
		<div className="grid gap-3 rounded-lg border bg-background p-3 xl:grid-cols-[1.5fr_0.9fr]">
						...
						{riskItems.length > 0 ? (
							riskItems.map((risk) => (
								<button
									...
									className="flex items-center justify-between gap-3 rounded-md border bg-background px-3 py-2 text-left text-xs transition-colors hover:border-primary/30 hover:bg-primary/5 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring"
								>
