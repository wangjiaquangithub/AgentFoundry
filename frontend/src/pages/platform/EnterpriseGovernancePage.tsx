	...
	return (
		<PlatformPageShell>
			...
			<Tabs defaultValue="identity">
				...
				<TabsContent value="leave" className="grid gap-4" data-testid="approval-center">
